---
description: Set Aftertone voice preset and restart daemon. Use when the user runs /aftertone_voice.
---

## Agent rule

**No planning.** Do not explain or run shell first unless the user named a preset (e.g. `/aftertone_voice F4`, `Sara`).
...
```
uv run --directory INSTALL/py python -m aftertone set voice PRESET --ensure
```
